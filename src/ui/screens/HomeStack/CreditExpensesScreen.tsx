...
export function CreditExpensesScreen({ refreshTrigger = 0, crud }: CreditExpensesScreenType) {
  ...
  return (
    ...
    {/* Container General */}
      ...
      {/* Sombras */}
      <View style={{elevation: 7, backgroundColor: "rgba(0,0,0,0.2)", position: 'absolute', height: '50%', width:100, zIndex: -1, borderTopStartRadius: 10, borderTopEndRadius: 10}}/>
      <View style={{elevation: 7, backgroundColor: "rgba(0,0,0,0.2)", position: 'absolute', height: '50%', width:150, zIndex: -1, borderTopStartRadius: 10, borderTopEndRadius: 10, right: 0}}/>
      <View style={{elevation: 7, backgroundColor: "rgba(0,0,0,0.2)", position: 'absolute', height: '50%', width:'100%', zIndex: -1, borderBottomStartRadius: 10, borderBottomEndRadius: 10 , bottom: 0}}/>
      {/* Sombras */}

      {/* Card de egresos */}
      <View style={{ backgroundColor: '#D9E7CB', minHeight: 100, borderBottomStartRadius: 10, borderBottomEndRadius: 10, padding: 4}}>
